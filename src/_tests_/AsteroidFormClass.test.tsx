...
describe("Asteroid Form Classes Test", () => {
  ...
  it("should Random code work properly", async () => {
    ...
    //   )
      // .reply(200, { ok: true });
      const buttonElement = screen.getByRole('button',{name:"RandomBtn"}); 
        fireEvent.click(buttonElement);
  ...
  //   mock.onGet('https://api.nasa.gov/neo/rest/v1/neo/browse?api_key=6202jSPpG2GqkXh8LHBaPbumSZ1WVY8evbdOavNs').reply(500, { error: 'Server Error' });
  //   fireEvent.click(buttonElement);
  //   await waitFor(() => {
